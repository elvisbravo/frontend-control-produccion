    ...
    <div class="card adminuiux-card mb-4">
        <div class="card-header">
            <div class="row gx-3 gx-lg-4 align-items-center">
                <div class="col">
                    <p class="h6">Standard DataTable</p>
                </div>
                <div class="col-auto">
            ...
            <div class=" mb-4">
                <table class="table w-100 nowrap" id="dataTable">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th class="xs sm">Patient</th>
                            <th class="xs sm md">Contact info</th>
                            <th class="xs sm">Tags</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="https://www.adminuiux.com/adminuiux/adminux/html/adminux-view-patient.html" class="btn btn-square btn-link" data-bs-toggle="tooltip" title="View">
                                    <i class="bi bi-eye"></i>
                                </a>
                        ...
                        <tr>
                            ...
                            <td><a href="https://www.adminuiux.com/adminuiux/adminux/html/adminux-view-patient.html" class="btn btn-square btn-link" data-bs-toggle="tooltip" title="View">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <div class="dropdown d-inline-block">
                                    <a class="btn btn-link no-caret" data-bs-toggle="dropdown">
            ...
            &lt;table id="clientScheduleGrid" class="table w-100 nowrap"&gt;
                ...
                &lt;tbody&gt;
                    &lt;tr&gt;
                        ...
                        &lt;td&gt;
                            &lt;a href="adminux-view-patient.html" class="btn btn-square btn-link" data-bs-toggle="tooltip" title="View"&gt;
                                &lt;i class="bi bi-eye"&gt;&lt;/i&gt;
                            &lt;/a&gt;
                            &lt;div class="dropdown d-inline-block"&gt;
                                &lt;a class="btn btn-link no-caret" data-bs-toggle="dropdown"&gt;
